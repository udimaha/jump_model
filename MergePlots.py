...
if __name__ == '__main__':
	output_path = Path("~/university/jump_model_exp/")
	...
	merge_files(visualized_path, pattern, output_path / "island-3-1024.gif")
	merge_files(visualized_path, normalized_pattern, output_path / "norm-island-3-1024.gif")
